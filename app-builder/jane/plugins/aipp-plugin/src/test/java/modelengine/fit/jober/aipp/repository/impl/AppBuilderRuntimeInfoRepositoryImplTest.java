...
class AppBuilderRuntimeInfoRepositoryImplTest extends DatabaseBaseTest {
    ...
    void testGetExpiredRuntimeInfosSuccess() {
        ...
        List<Long> expiredRuntimeInfos = this.runtimeInfoRepository.getExpiredRuntimeInfos(0, 1);

        Assertions.assertEquals(1, expiredRuntimeInfos.size());
        Assertions.assertEquals(1L, expiredRuntimeInfos.get(0));
    }
